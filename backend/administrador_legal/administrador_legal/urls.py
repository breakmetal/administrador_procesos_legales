"""administrador_legal URL Configuration
...
urlpatterns = [
    ...
    re_path(r'^dashboard/?.*$', include('apps.index.urls')),
    ...
    path("accounts/reset/done/", auth_views.PasswordResetView.as_view(template_name='registration/password_reset_complete.html'), name='password_reset_complete'),  
